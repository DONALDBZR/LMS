        ...
        if (count($this->API->resultSet()) < 3) {
            ...
            if (!empty($this->API->resultSet())) {
                ...
                if (!empty($this->API->resultSet())) {
                    ...
                    header("refresh:4.4; url=http://stormysystem.ddns.net/LibraryManagementSystem/Member/Profile/Reserved_Books");
                } else {
                    echo "
                    <h1 id='failure'>
                    ...
                    header("refresh:4.6; url=http://stormysystem.ddns.net/LibraryManagementSystem/Member");
                }
            } else {
                echo "
                <h1 id='failure'>
                ...
                header("refresh:4.8; url=http://stormysystem.ddns.net/LibraryManagementSystem/Member/Logout");
            }
        } else {
            echo "
            <h1 id='failure'>
